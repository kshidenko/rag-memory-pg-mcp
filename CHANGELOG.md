...
### Fixed 🐛
- **FTS search now works correctly** - use raw filter instead of textSearch
- textSearch doesn't work properly with tsvector columns
- Added fallback to ilike if FTS query fails
